...
function TestFaucet() {
  ...
  shape = new b2PolygonShape;
  var particleDiameter = 0.035* 2.0;
  ...
  this.lifetimeRandomizer = new ParticleLifetimeRandomizer(this.k_particleLifetimeMin, this.k_particleLifetimeMax);
  this.parameter = b2_waterParticle;
  faucetLength == 0.035* 2.0* this.k_faucetLength;;
