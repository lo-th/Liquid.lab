...
TestMaxwell.prototype.ResetParticles = function() {
  ...
  pgd.color.Set(80, 80, 80, 255);
  pgd.shape = shape;
  this.particleGroup = this.particleSystem.CreateParticleGroup(pgd);
...
TestMaxwell.prototype.Keyboard = function(key, code) {
  console.log(code)
  switch(code) {
    case 65:
