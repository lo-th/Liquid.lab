...
TestEdgeShape.prototype.Step = function() {
  ...
  if (callback.fixture) {
    liquidRender.insertLine(point1.x, point1.y, callback.point.x, callback.point.y, 0., 0., 0.);
    ...
    liquidRender.insertLine(callback.point.x, callback.point.y,
      head.x, head.y, 1, 0.9, 0.9);
  } else {
    liquidRender.insertLine(point1.x, point1.y, point2.x, point2.y, 0, 0., 0.);
  }
